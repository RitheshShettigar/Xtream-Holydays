									...
									<div class="row">
										<div class="col-12 col-lg-12 mt-3">
											<section class="container">
												<form method = "post" action = "billdb.php">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type ="date" class="form-control" value="<?php echo date('Y-m-d'); ?>" min="2023-01-01" max="2025-12-31" name="date" id="date">														
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <select class="form-control" name="bank_details" id="bank_details">
                                                                    ...
                                                                    <?php
                                                                            ...
                                                                            { 
                                                                                ?>
                                                                                    <option value="<?php echo $bank_arr['id']; ?>"><?php echo $bank_arr['acc_holder_name']. ' - ' .$bank_arr['bank_name']; ?></option>
                                                                                <?php
                                                                            }
                                                                        ?>
                                                                </select>														
                                                                ...
                                                                <select class="form-control"  name="cust_details" id="cust_details">
                                                                    ...
                                                                    <?php
                                                                            ...
                                                                            { 
                                                                                ...
                                                                                ?>
                                                                                    <option value="<?php echo $cust_arr['id']; ?>"><?php echo $name. ' - ' .$cust_arr['contact']; ?></option>
                                                                                <?php
                                                                            }
                                                                        ?>
                                                                </select>														
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <select  class="form-control" name="comp_details" id="comp_details">
                                                                    ...
                                                                    <?php
                                                                            ...
                                                                            { 
                                                                                ?>
                                                                                    <option value="<?php echo $comp_arr['id']; ?>"><?php echo $comp_arr['firm_name']. ' - ' .$comp_arr['gst_no']; ?></option>
                                                                                <?php
                                                                            }
                                                                        ?>
                                                                </select>														
