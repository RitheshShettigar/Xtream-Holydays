				...
				<div class="col-12  align-self-center">
					<div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded">
						<div class="w-sm-100 mr-auto">
							<h4 class="mb-0">Expired Package Report</h4>
						</div>
								...
								<table id="example" class="display table dataTable table-striped table-bordered" >
									...
									<tbody>
										<?php
											$i = 1;
											$date = date('Y-m-d');
											$sql_package = "SELECT * from package_master  WHERE status = 0 and  tdate <=DATE(NOW()) order by id desc";
											...
											while($sql_package_arr = mysqli_fetch_array($sql_package_rs))
											{
											    ...
											    ?>
													<tr>
														...
														<td><?php echo date('Y-m-d', strtotime($sql_package_arr['fdate'])); ?></td>
														<td><?php echo date('Y-m-d', strtotime($sql_package_arr['tdate'])); ?></td>
														...
														<td>
															<div class="btn-group">
																...
																<div class="dropdown-menu p-0">
																	...
																	<a class="dropdown-item" href="package-flight-details.php">Flight Details</a>
																</div>
														</td>
													</tr>
												<?php
