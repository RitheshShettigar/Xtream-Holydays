					...
					<div class="col-12  align-self-center">
						<div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded">
							<div class="w-sm-100 mr-auto">
								<h4 class="mb-0">User Bookings Package</h4>
							</div>
								...
								<div class="table-responsive">
									<table id="example" class="display table dataTable table-striped table-bordered" >
										...
										<tbody>
                                            <?php
                                                $i=1;
                                                $sql_fetch_web = "select * from tour_request order by id desc";
                                                ...
                                                while($sql_fetch_web_arr = mysqli_fetch_array($sql_fetch_web_rs))
                                                {
                                                    ...
                                                    ?>
                                                        ...
                                                        <td><?php echo $sql_fetch_web_arr['mobile'] ?></td>
                                                        <td><a href ="mail.php?email=<?php echo $sql_fetch_web_arr['email'] ?>" target = "_blank"><?php echo $sql_fetch_web_arr['email'] ?></a></td>
                                                        <td><?php echo $sql_fetch_web_arr['days'] ?></td>
														<td><?php echo $sql_fetch_web_arr['arrival'] ?></td>
                                                        <td><?php echo $sql_fetch_web_arr['check_in_dt'] ?></td>
                                                        <td><?php echo $sql_fetch_web_arr['check_out_dt'] ?></td>
                                                        <td><?php echo $sql_fetch_web_arr['persons'] ?></td>
                                                        <td><?php echo $sql_fetch_web_arr['departure'] ?></td>

														<td><?php echo $sql_fetch_web_arr['budget'] ?></td>
														<td><?php echo $sql_fetch_web_arr['ty_stay'] ?></td>
                                                        <td><?php echo $sql_fetch_web_arr['message'] ?></td>
                                                        <td><?php echo $sql_fetch_web_arr['travel_ty'] ?></td>
			...
			<div class="container-fluid">
				...
				<div class="row ">
					<div class="col-12  align-self-center">
						<div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded">
							<div class="w-sm-100 mr-auto">
								<h4 class="mb-0">User Bookings Offer Package</h4>
							</div>
							<ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
								<li class="breadcrumb-item">Home</li>
								<li class="breadcrumb-item">Lead</li>
								...
								<div class="table-responsive">
									<table id="example" class="display table dataTable table-striped table-bordered" >
										...
										<tbody>
                                            <?php
                                                $i=1;
                                                $sql_fetch_web = "select * from package_offer order by id desc";
                                                $sql_fetch_web_rs = mysqli_query($con, $sql_fetch_web);
