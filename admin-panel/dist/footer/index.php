<!-- START: Footer-->
<footer class="site-footer">© <?php echo date('Y'); ?> Scopycode.</footer>
<!-- END: Footer-->
<!-- START: Back to top-->
...
<script src="dist\vendors\summernote\summernote-bs4.js" ></script>
<script src="dist/js/summernote.script.js"></script>
